  ...
  return (
    ...
    >
      <span className="absolute right-0 grid grid-cols-4 gap-1">
        <p>Level:</p>
        <p className="before:content-[''] before:w-2 before:h-2 before:bg-sky-500 before:inline-flex before:rounded-full before:mr-2" id="1">
          Experienced
        </p>
        <p className="before:content-[''] before:w-2 before:h-2 before:bg-orange-500 before:inline-flex before:rounded-full before:mr-2" id="2">
          Basics
        </p>
        <p className="before:content-[''] before:w-2 before:h-2 before:bg-white before:inline-flex before:rounded-full before:mr-2" id="3">
          Learning
        </p>
      </span>
      <h2 className="text-2xl py-8 font-mono">SKILLS</h2>
      <ul className="grid gap-3 mx-5" style={{gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))"}}>
